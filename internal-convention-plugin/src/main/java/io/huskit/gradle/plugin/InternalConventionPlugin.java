...
import com.varlanv.testkonvence.gradle.plugin.TestKonvenceExtensionView;
import com.varlanv.testkonvence.gradle.plugin.TestKonvencePlugin;
    ...
    public void apply(Project project) {
        ...
        pluginManager.withPlugin(
            ...
            ignore -> {
                ...
                pluginManager.apply(TestKonvencePlugin.class);
                if (internalEnvironment.isLocal()) {
        ...
        project.afterEvaluate(ignore -> {
                ...
                pluginManager.withPlugin(
                    ...
                    plugin -> {
                        ...
                        java.withSourcesJar();
                        var testKonvenceExtension = (TestKonvenceExtensionView) extensions.getByName(TestKonvenceExtensionView.name());
                        testKonvenceExtension.reverseTransformation(spec -> {
                            spec.enabled(true);
                        });
